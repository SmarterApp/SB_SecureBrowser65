...
typedef struct
{
    ...
    int (*open_func)(std::vector<unsigned char>& input, oe_enc_opt *opt, unsigned char *buf, int buflen);
...
int raw_open(std::vector<unsigned char>& input, oe_enc_opt *opt, unsigned char *buf, int buflen);
