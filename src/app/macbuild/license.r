...
data 'TEXT' (5000, "English") {
  "OaksSecureBrowser END-USER SOFTWARE LICENSE AGREEMENT\n"
  "Version 3.0\n"
  "\n"
  "A SOURCE CODE VERSION OF CERTAIN OaksSecureBrowser FUNCTIONALITY THAT YOU MAY USE, MODIFY AND DISTRIBUTE IS AVAILABLE TO YOU FREE-OF-CHARGE FROM WWW.MOZILLA.ORG UNDER THE MOZILLA PUBLIC LICENSE and other open source software licenses.\n"
  "\n"
  "The accompanying executable code version of OaksSecureBrowser and related documentation (the “Product”) is made available to you under the terms of this OaksSecureBrowser END-USER SOFTWARE LICENSE AGREEMENT (THE “AGREEMENT”).  BY CLICKING THE “ACCEPT” BUTTON, OR BY INSTALLING OR USING THE OaksSecureBrowser, YOU ARE CONSENTING TO BE BOUND BY THE AGREEMENT.  IF YOU DO NOT AGREE TO THE TERMS AND CONDITIONS OF THIS AGREEMENT, DO NOT CLICK THE “ACCEPT” BUTTON, AND DO NOT INSTALL OR USE ANY PART OF THE OaksSecureBrowser.\n"
  "\n"
  "DURING THE OaksSecureBrowser INSTALLATION PROCESS, AND AT LATER TIMES, YOU MAY BE GIVEN THE OPTION OF INSTALLING ADDITIONAL COMPONENTS FROM THIRD-PARTY SOFTWARE PROVIDERS.  THE INSTALLATION AND USE OF THOSE THIRD-PARTY COMPONENTS MAY BE GOVERNED BY ADDITIONAL LICENSE AGREEMENTS.\n"
  "\n"
  "1.  LICENSE GRANT.  The American Institutes for Research grants you a non-exclusive license to use the executable code version of the Product.  This Agreement will also govern any software upgrades provided by OaksSecureBrowser that replace and/or supplement the original Product, unless such upgrades are accompanied by a separate license, in which case the terms of that license will govern.\n"
  "\n"
  ...
  "\n"
  "3.  PROPRIETARY RIGHTS.  Portions of the Product are available in source code form under the terms of the OaksSecureBrowser Public License and other open source licenses (collectively, “Open Source Licenses”) at http://mozilla.org.  Nothing in this Agreement will be construed to limit any rights granted under the Open Source Licenses.  Subject to the foregoing, OaksSecureBrowser, for itself and on behalf of its licensors, hereby reserves all intellectual property rights in the Product, except for the rights expressly granted in this Agreement.  You may not remove or alter any trademark, logo, copyright or other proprietary notice in or on the Product.  This license does not grant you any right to use the trademarks, service marks or logos of OaksSecureBrowser or its licensors.\n"
  "\n"
  "4.  PRIVACY POLICY.  You agree to the OaksSecureBrowser Privacy Policy, made available online at http://www.mozilla.com/firefox/privacy/, as that policy may be changed from time to time.  When Mozilla changes the policy in a material way a notice will be posted on the website at www.mozilla.com and when any change is made in the privacy policy, the updated policy will be posted at the above link.  It is your responsibility to ensure that you understand the terms of the privacy policy, so you should periodically check the current version of the policy for changes.\n"
  "\n"
  ...
  "\n"
  "9.  MISCELLANEOUS.  (a) This Agreement constitutes the entire agreement between OaksSecureBrowser and you concerning the subject matter hereof, and it may only be modified by a written amendment signed by an authorized executive of OaksSecureBrowser.  (b) Except to the extent applicable law, if any, provides otherwise, this Agreement will be governed by the laws of the state of California, U.S.A., excluding its conflict of law provisions.  (c) This Agreement will not be governed by the United Nations Convention on Contracts for the International Sale of Goods.  "
  ...
  "(g) You may assign your rights under this Agreement to any party that consents to, and agrees to be bound by, its terms; the American Institutes for Research may assign its rights under this Agreement without condition.  (h) This Agreement will be binding upon and inure to the benefit of the parties, their successors and permitted assigns."
};
